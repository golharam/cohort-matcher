...
TAG=0.1
#PROXY=--build-arg http_proxy=http://proxy-server.bms.com:8080 --build-arg https_proxy=http://proxy-server.bms.com:8080 --build-arg ftp_proxy=http://proxy-server.bms.com:8080
PROXY=
